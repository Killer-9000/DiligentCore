...
public:
    ...
    WGPUInstance DILIGENT_CALL_TYPE GetWebGPUInstance() override { return m_wgpuInstance.Get(); }

    /// Implementation of IRenderDeviceWebGPU::GetWebGPUAdapter() in WebGPU backend.
    WGPUAdapter DILIGENT_CALL_TYPE GetWebGPUAdapter() override { return m_wgpuAdapter.Get(); }

    /// Implementation of IRenderDeviceWebGPU::GetWebGPUDevice() in WebGPU backend.
    WGPUDevice DILIGENT_CALL_TYPE GetWebGPUDevice() override { return m_wgpuDevice.Get(); }
