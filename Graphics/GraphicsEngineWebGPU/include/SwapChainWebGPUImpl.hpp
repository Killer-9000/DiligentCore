...
public:
    ...
    /// Implementation of ISwapChainWebGPU::GetWebGPUSwapChain() in WebGPU backend.
    WGPUSwapChain DILIGENT_CALL_TYPE GetWebGPUSwapChain() override { return m_wgpuSwapChain.Get(); }
    ...
    ITextureView* DILIGENT_CALL_TYPE GetCurrentBackBufferRTV() override;

     /// Implementation of ISwapChainWebGPU::GetDepthBufferDSV() in WebGPU backend.
    ITextureView* DILIGENT_CALL_TYPE GetDepthBufferDSV() override;

private:
    WebGPUSurfaceWrapper   m_wgpuSurface;
    WebGPUSwapChainWrapper m_wgpuSwapChain;
};
